  ...
  return (
    <Fragment>
      <Container className="w-75">
        ...
        <Row>
          <Col md={4} xs={6} className="m-5 d-flex justify-content-around">
            <div>
            <img className="rounded-circle"  style={{width:'100%'}} src={'https://prasadyash2411.github.io/ecom-website/img/Band%20Members.png'} />
            </div>
            
          </Col>
          <Col className="m-5 d-flex justify-content-around ">
